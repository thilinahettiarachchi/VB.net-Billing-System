Public Class Form_water
    ...
    Private Sub btn_pay_Click(sender As Object, e As EventArgs) Handles btn_pay.Click
        If txt_billnumber.Text = "" And txt_cashreceived1.Text = "" And txt_customername.Text = "" And txt_nic.Text = "" And txt_paymentamount.Text = "" And txt_telephonenumber.Text = "" Then
            MessageBox.Show("Please fill all fields", "Error")
        Else
            Try
                pay = txt_paymentamount.Text
                cash = txt_cashreceived1.Text
                balance = cash - pay
    ...
    Private Sub Form_water_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lbl_user.Text = user
        Timer1.Enabled = True
    ...
    Private Sub ToolStripButton4_Click(sender As Object, e As EventArgs) Handles ToolStripButton4.Click
        MessageBox.Show("This is for water bill payment")
    End Sub
End Class